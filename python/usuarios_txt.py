...
def validar_quantidade_campos(dados):
    if len(dados) != 4:
        print("Linha invalida, nem todos os dados estão preenchidos.")
        return None

    nome, idade, email, senha = dados
    return nome, idade, email, senha
    ...
    while True:
        ...
        try:
            ...
            if idade < 0 or idade > 120:
                idade = input(
                    f"Idade invalida do {nome}, digite novamente: "
                )
                continue
            ...
            idade = input(
                f"Idade invalida para {nome}, digite novamente usando numeros: "
            )
...
def carregar_usuarios():
    ...
    with open(
        ...
        for linha in arquivo:
            ...
            resultado = validar_quantidade_campos(
                dados
            )
            ...
            nome, idade, email, senha = resultado
